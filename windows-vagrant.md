...
- [2. Install Four Programs](#step-two-install-four-programs):
  ...
  - [Program 1: visual studio code](#program-one-VSC-text-editor)
...
If you feel confident updating your BIOS settings to enable virtualization, do so at your own risk, or discuss the option with your instructor/ta/mentor. It's still recommended to get setup with [Codenvy](windows.md#step-two-set-up-a-cloud-ide-alternative) in the meantime so that you can begin working through the material.
...
**If you utilize any Cloud storage systems (such as OneDrive), you __must not__ unzip the Coding Environment to your Cloud Desktop. It must be unzipped to your true, local Desktop. If you have any questions, reach out to the Instructor/TA Team.**
...
You will need to install visual studio code(VSC), VirtualBox, PuTTY, and Vagrant to set up your coding environment.
...
1. Go to the [VSC Text Editor website](https://code.visualstudio.com/download) and click the Download for Windows button.
...
If you need more help installing VSC, google visual studio code install.
...
1. Go to the [Download Vagrant page](http://www.vagrantup.com/downloads.html), click and Find the Windows section and click Universal (32 and 64-bit)
...
The previous steps installed the four programs that are needed to use a Vagrant virtual machine. Now you are ready to turn on the virtual environment.
...
If you encountered an output that is different than the above actions your environment is in a state that is slightly different than these instructions expect. Because of this, you should ask your instructor/TA/mentor for help.
...
Now that your environment is successfully installed, set up, and configured you can test that the environment is able to run a Ruby on Rails project we have pre installed.
